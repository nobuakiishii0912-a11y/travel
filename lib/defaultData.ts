...
export const initialData: ScheduleItem[] = [
  ...
  { 
    ...
    address: '10 Bayfront Ave, シンガポール 018956', googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=1.2834,103.8607', openingHours: { open: '00:00', close: '23:59' },
    category: 'Hotel', priority: 'Low', order: 0, transport: { type: '徒歩', durationMin: 15 }, stayDurationMin: 0, highlights: ['2日目スタート！'], warnings: [], showTaxiCard: false
  },
  {  
    ...
    category: 'Sightseeing', priority: 'High', order: 1, transport: { type: '徒歩', durationMin: 15 }, stayDurationMin: 60, highlights: ['前日の夜に見上げたスーパーツリーを、今度は地上22mの空中散歩で間近に観察します。'], warnings: ['吊り橋（OCBC Skyway）は9:00オープン。'], showTaxiCard: false
  },
  { 
    ...
    category: 'Food', priority: 'Medium', order: 2, transport: { type: '徒歩', durationMin: 5 }, stayDurationMin: 45, highlights: ['10:00オープン。紅茶の茶葉を練り込んだマカロンやスイーツで優雅な朝 of ティータイム。'], warnings: [], showTaxiCard: false
  },
  { 
    ...
    address: '10 Bayfront Ave, シンガポール 018956', googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=1.2834,103.8607', openingHours: { open: '00:00', close: '23:59' },
    category: 'Hotel', priority: 'High', order: 3, transport: { type: 'タクシー', durationMin: 10 }, stayDurationMin: 20, highlights: ['ホテルチェックアウト'], warnings: [], showTaxiCard: false
  },
  { 
    ...
    address: '89 Short Street, Singapore 188216', googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=89+Short+Street,+Singapore+188216', openingHours: { open: '00:00', close: '23:59' },
    category: 'Hotel', priority: 'High', order: 4, transport: { type: 'タクシー', durationMin: 15, route: 'チャイナタウンへ移動' }, stayDurationMin: 10, highlights: ['2泊目ホテルに荷物を預ける'], warnings: [], showTaxiCard: true 
  },
  { 
    ...
    category: 'Sightseeing', priority: 'High', order: 5, transport: { type: '徒歩', durationMin: 5 }, stayDurationMin: 60, highlights: ['ヒンドゥー教の極彩色の神々の彫刻と、純金420kgで作られた巨大な仏塔は必見。'], warnings: ['まず「スリ・マリアマン寺院」へ（12:00〜18:00は中休み）。その後「Buddha Tooth Relic Temple」へ。肌の露出NGです。'], showTaxiCard: true 
  },
  { 
    ...
    category: 'Food', priority: 'High', order: 6, transport: { type: '徒歩', durationMin: 10 }, stayDurationMin: 60, highlights: ['ふっくらジューシーなチキンと、鶏出汁ライスの相性が抜群。'], warnings: ['マックスウェル・フードセンター内。行列必至。先にポケットティッシュ等で席を確保するのが鉄則。'], showTaxiCard: false
  },
  { 
    ...
    category: 'Food', priority: 'Medium', order: 7, transport: { type: '徒歩', durationMin: 5 }, stayDurationMin: 45, highlights: ['半熟卵にダークソイソースをかけ、本店限定の炭火焼きトーストをディップするローカル流おやつ。'], warnings: [], showTaxiCard: false
  },
  { 
    ...
    category: 'Sightseeing', priority: 'Low', order: 8, transport: { type: '徒歩', durationMin: 15 }, stayDurationMin: 30, highlights: ['地上280mからマリーナベイを一望できる最新の超高層絶景スポット。緑豊かな屋内庭園の散策も楽しめます。'], warnings: ['月〜金の平日限定で一般無料開放（午後は14:30〜18:00）。'], showTaxiCard: false
  },
  { 
    ...
    category: 'Sightseeing', priority: 'High', order: 9, transport: { type: 'タクシー', durationMin: 15, route: 'ホテル（Hotel Mi Rochor）へ移動' }, stayDurationMin: 35, highlights: ['手乗りの遠近法トリック写真など定番の撮影を。'], warnings: [], showTaxiCard: false
  },
  { 
    id: '20', date: '2026-09-09', title: 'Hotel Mi Rochor（チェックイン）', startTime: '16:20', endTime: '17:10', locationName: 'Hotel Mi Rochor', lat: 1.3015, lng: 103.8526, 
    address: '89 Short Street, Singapore 188216', googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=89+Short+Street,+Singapore+188216', openingHours: { open: '00:00', close: '23:59' },
    category: 'Hotel', priority: 'High', order: 10, transport: { type: '地下鉄＆シャトルバス', durationMin: 80, route: '地下鉄＆シャトルバスでナイトサファリへ移動（約80分）', mapUrl: 'https://maps.app.goo.gl/TcCJ6UNvGGCexsXA8' }, stayDurationMin: 50, highlights: ['ホテルにチェックイン。お部屋で少し休憩してから、夜のナイトサファリへ備えましょう。'], warnings: [], showTaxiCard: true 
  },
  { 
  ...
  { 
    ...
    address: '89 Short Street, Singapore 188216', googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=89+Short+Street,+Singapore+188216', openingHours: { open: '00:00', close: '23:59' },
    category: 'Hotel', priority: 'Low', order: 12, transport: { type: 'なし', durationMin: 0 }, stayDurationMin: 0, highlights: ['2日目終了。ホテルに帰着しておやすみなさい。'], warnings: [], showTaxiCard: true 
  },
  ...
  { 
    ...
    address: '89 Short Street, Singapore 188216', googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=89+Short+Street,+Singapore+188216', openingHours: { open: '00:00', close: '23:59' },
    category: 'Hotel', priority: 'Low', order: 0, transport: { type: '徒歩', durationMin: 10 }, stayDurationMin: 0, highlights: ['3日目スタート！'], startTime: '08:30', endTime: '08:30', warnings: [], showTaxiCard: false
  },
  { 
    ...
    category: 'Sightseeing', priority: 'Low', order: 1, transport: { type: '徒歩', durationMin: 10 }, stayDurationMin: 60, highlights: ['スパイスの香りが漂うカラフルな街並みで異国情緒あふれる写真撮影。'], warnings: [], showTaxiCard: false
  },
  { 
    ...
    category: 'Sightseeing', priority: 'Medium', order: 2, transport: { type: '徒歩', durationMin: 5 }, stayDurationMin: 30, highlights: ['バラマキ土産が所狭しと並ぶローカルなアーケード街散策。スリに注意。'], warnings: [], showTaxiCard: false
  },
  { 
    ...
    category: 'Sightseeing', priority: 'High', order: 3, transport: { type: 'タクシー', durationMin: 10 }, stayDurationMin: 60, highlights: ['Haji Lnのポップなウォールアート撮影とエキゾチックな雑貨探し。'], warnings: ['サルタン・モスク見学は10:00〜12:00。肌の露出NG。'], showTaxiCard: false
  },
  { 
    ...
    category: 'Sightseeing', priority: 'Medium', order: 4, transport: { type: 'タクシー', durationMin: 10, route: 'クラークキー方面へ' }, stayDurationMin: 60, highlights: ['シンガポール最大のショッピングストリートでウィンドウショッピング。'], warnings: [], showTaxiCard: true 
  },
  { 
    ...
    category: 'Food', priority: 'High', order: 5, transport: { type: '徒歩', durationMin: 5 }, stayDurationMin: 60, highlights: ['胡椒とニンニクが効いた絶品スープは何度でもおかわり無料。油条（揚げパン）を浸して食べます。'], warnings: [], showTaxiCard: true 
  },
  { 
    ...
    category: 'Sightseeing', priority: 'Low', order: 6, transport: { type: 'タクシー', durationMin: 10 }, stayDurationMin: 20, highlights: ['927枚もの窓枠がレインボーカラーに塗られた歴史的建築。昼間の青空に映えるカラフルな色彩は絶行の写真スポットです。'], warnings: ['現在は官公庁として使用されているため、外観のみの撮影となります。道路の交通量が多いので撮影時は注意。'], showTaxiCard: false
  },
  { 
    ...
    category: 'Sightseeing', priority: 'Medium', order: 7, transport: { type: 'タクシー', durationMin: 10 }, stayDurationMin: 30, highlights: ['右手で水に触れながら、願い事を念じて泉の周りを時計回りに3周すると願いが叶うと言われています。'], warnings: [], showTaxiCard: true 
  },
  { 
    ...
    address: '89 Short Street, Singapore 188216', googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=89+Short+Street,+Singapore+188216', openingHours: { open: '00:00', close: '23:59' },
    category: 'Hotel', priority: 'High', order: 8, transport: { type: 'タクシー', durationMin: 15 }, stayDurationMin: 15, highlights: ['預けた荷物をピックアップ'], warnings: [], showTaxiCard: true 
  },
  { 
    ...
    category: 'Sightseeing', priority: 'Medium', order: 9, transport: { type: '徒歩', durationMin: 5 }, stayDurationMin: 40, highlights: ['パステルカラーの美しい伝統建築を背景にした写真撮影。'], warnings: ['一般住宅なので敷地内に入ったり大声を出さないようマナー厳守。'], showTaxiCard: true 
  },
  { 
